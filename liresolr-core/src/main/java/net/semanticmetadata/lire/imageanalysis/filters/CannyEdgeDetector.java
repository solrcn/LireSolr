...
public class CannyEdgeDetector {
    ...
    BufferedImage bimg;
     ...
     /**
      * Create a Canny Edge Detector for the given image. Set the thresholds yourself. Use {@link net.semanticmetadata.lire.imageanalysis.filters.CannyEdgeDetector#filter} to create
      * the edge image.
