...
public class SPCEDD implements LireFeature {
     ...
     * @see net.semanticmetadata.lire.imageanalysis.spatialpyramid.SPCEDD#setByteArrayRepresentation(byte[])
     */
     ...
     * @see net.semanticmetadata.lire.imageanalysis.spatialpyramid.SPCEDD#getByteArrayRepresentation
     */
