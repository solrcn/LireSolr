...
public class ArrayFastmapDistanceMatrix implements FastmapDistanceMatrix {
     ...
     * {@link net.semanticmetadata.lire.indexing.fastmap.FastmapDistanceMatrix#getMaximumDistance(int, int, double[][])} with parameters (row, 0, null, null).
     *
     * @param row defines the row where we want to find the maximum
     * @return the index of the object with maximum distance to the row object.
     * @see net.semanticmetadata.lire.indexing.fastmap.FastmapDistanceMatrix#getMaximumDistance(int, int, double[][])
     */
