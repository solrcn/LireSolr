...
public class ImageSearcherFactory {
     ...
     * hits defined in the {@link net.semanticmetadata.lire.ImageSearcherFactory#NUM_MAX_HITS} based on the {@link net.semanticmetadata.lire.imageanalysis.CEDD} feature
     *
     * @return the searcher instance
     */
     ...
     * @see net.semanticmetadata.lire.ImageSearcher
     ...
     * It won't work out if you don't use {@link net.semanticmetadata.lire.DocumentBuilderFactory#getHashingCEDDDocumentBuilder()}
     * or the code within.
     *
     * @param maximumHits
     * @return
