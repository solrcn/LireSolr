...
public class GenericFastImageSearcher extends AbstractImageSearcher {
     ...
     * @param descriptorClass the feature class. It has to implement {@link net.semanticmetadata.lire.imageanalysis.LireFeature}
     * @param fieldName       a custom field name for the index.
     * @see net.semanticmetadata.lire.imageanalysis.LireFeature
     */
